...
const Fish = createLucideIcon("fish", __iconNode$g);
const __iconNode$f = [
...
const __iconNode$9 = [["path", { d: "m8 3 4 8 5-5 5 15H2L8 3z", key: "otkl63" }]];
const Mountain = createLucideIcon("mountain", __iconNode$9);
const __iconNode$8 = [
  [
    "path",
    {
